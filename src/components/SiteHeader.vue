		...
		<header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
			<div class="flex justify-between px-4 py-3 xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5">
					<div>
						<router-link to="/">
							<svg class="h-8 w-auto" viewBox="0 0 185 32" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path d="M43.911 12.604L36.213 8.16v20.645h9v2h-44v-2h4v-12.72l-3.728.933L1 15.078l21.09-5.273h3.122a9.552 9.552 0 0 0-.68 2.559l-.483 3.975 5.164-2.982v15.448h5V8.161l-7.696 4.444a7.502 7.502 0 0 1 2.565-4.8h-4.12a7.489 7.489 0 0 1 6.646-2.973l-5.591-3.228a7.488 7.488 0 0 1 6.696.402c1.039.6 1.88 1.41 2.5 2.347a7.461 7.461 0 0 1 2.5-2.347 7.49 7.49 0 0 1 6.698-.402l-5.593 3.228a7.488 7.488 0 0 1 6.646 2.973h-4.12a7.498 7.498 0 0 1 2.567 4.8zM25.213 28.805v-10h-6v10h6zm-11-8a2 2 0 1 1-4 0 2 2 0 0 1 4 0z" fill="#A3BFFA"/>
							</svg>
						</router-link>
					</div>
						<div class="flex sm:hidden">
							<button @click="toggle" class="px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white" >
								<svg class="h-6 w-6 fill-current text-gray-500 hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
									<path v-if="isOpen" d="M18.278 16.864a1 1 0 0 1-1.414 1.414l-4.829-4.828-4.828 4.828a1 1 0 0 1-1.414-1.414l4.828-4.829-4.828-4.828a1 1 0 0 1 1.414-1.414l4.829 4.828 4.828-4.828a1 1 0 1 1 1.414 1.414l-4.828 4.829 4.828 4.828z"/>
				...
				<nav class="sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between" :class="{'hidden' : !isOpen, 'block' : isOpen }">
					...
					<input class="block w-full border border-transparent bg-gray-200 pl-10 pr-3 py-2 rounded-lg text-gray-900 focus:outline-none focus:bg-white focus:border-gray-400" placeholder="Search by keywords">
				</div>
				<div class="sm:flex sm:items-center">
					<div class="px-2 pt-2 py-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0">
						<a href="#" class=" block py-1 px-3 rounded hover:bg-gray-800 xl:hover:bg-gray-200 leading-tight font-semibold text-white xl:text-gray-900 sm:text-sm sm:px-2">List your Property</a>
						<a href="#" class=" block py-1 px-3 rounded hover:bg-gray-800 xl:hover:bg-gray-200 leading-tight mt-1 sm:mt-0 font-semibold text-white xl:text-gray-900 sm:text-sm sm:px-2 sm:ml-2">Trips</a>
						<a href="#" class=" block py-1 px-3 rounded hover:bg-gray-800 xl:hover:bg-gray-200 leading-tight mt-1 sm:mt-0 font-semibold text-white xl:text-gray-900 sm:text-sm sm:px-2 sm:ml-2">Messages</a>
					</div>
					<div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
						<div class="flex items-center sm:hidden">
							...
							<span class="font-semibold text-gray-200 ml-4 sm:hidden">Samantha Kanyonyo</span>
						</div>
						<Dropdown>
							<template #trigger>
								<span class="hidden sm:h-8 sm:w-8 sm:block sm:overflow-hidden sm:rounded-full sm:border-2 sm:border-gray-600 xl:border-gray-300 xl:hover:border-gray-400 xl:focus:outline-none sm:focus:outline-none sm:focus:border-white">
							...
							<template #dropdown>
								<div class="mt-5 sm:bg-white sm:rounded-lg sm:absolute sm:mt-3 sm:right-0 sm:py-2 sm:w-48 sm:shadow-xl">
									<a href="#account" class="block text-gray-400 xl:z-40 hover:text-white sm:text-gray-800 sm:px-4 sm:py-2 sm:hover:bg-indigo-500 xl:hover:bg-gray-200 xl:hover:text-black">Account settings</a>
									<a href="#support" class="mt-1 block text-gray-400 xl:z-40 hover:text-white sm:text-gray-800 sm:px-4 sm:mt-0 sm:py-2 sm:hover:bg-indigo-500 xl:hover:bg-gray-200 xl:hover:text-black">Support</a>
									<a href="#sign-out" class="mt-2 block text-gray-400 xl:z-40 hover:text-white sm:text-gray-800 sm:px-4 sm:mt-0 sm:py-2 sm:hover:bg-indigo-500 xl:hover:bg-gray-200 xl:hover:text-black">Sign Out</a>
								</div>
							</template>
						</Dropdown>
					</div>
