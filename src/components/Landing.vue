<template>
	<div class="bg-gray-100 antialised h-screen sm:h-full">
		<div class="px-8 py-12 max-w-xl mx-auto lg:max-w-full lg:py-20 lg:px-0 lg:relative lg:min-h-screen">
			<div class="xl:max-w-8xl lg:max-auto">
				<div class="lg:w-7/12 lg:pl-12 lg:pr-4">
					...
					<div class="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
						<img class="h-64 w-full object-cover object-center sm:h-72 rounded-lg shadow-xl lg-inset-0 lg:h-full lg:object-left lg:shadow-none lg:rounded-none" src="/images/beach-work.jpg" alt="Splash Page">
						<svg class="hidden lg:block absolute inset-y-0 left-0 w-16 h-full" preserveAspectRatio="none" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
							<polygon class="text-gray-100" fill="currentColor" points="0,0 0,100 100, 0"/>
						</svg>
					</div>
					<h1 class="mt-8 text-xl sm:text-3xl md:text-3xl lg:text-2xl lg:mt-12 font-bold text-gray-900 leading-tight">
